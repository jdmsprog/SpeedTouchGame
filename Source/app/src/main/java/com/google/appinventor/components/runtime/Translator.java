...
public final class Translator extends AndroidNonvisibleComponent {
    ...
    public void RequestTranslation(final String languageToTranslateTo, final String textToTranslate) {
        AsynchUtil.runAsynchronously(new Runnable() { // from class: com.google.appinventor.components.runtime.Translator.1
    ...
    public void performRequest(String languageToTranslateTo, String textToTranslate) {
        ...
        try {
            ...
            byte[] decodedToken = Base58Util.decode(this.apiKey);
            TranslatorToken.token token = TranslatorToken.token.parseFrom(decodedToken);
            TranslatorToken.request request = TranslatorToken.request.newBuilder().setToken(token).setTotranslate(textToTranslate).setSourcelanguage(srcLanguage).setTargetlanguage(targetLanguage).m391build();
            ...
            if (connection != null) {
                ...
                if (responseCode == 200) {
                    ...
                    returnText2 = getResponseContent(connection, DEBUG);
                }
                String translationOrError = returnText2;
    ...
    public void GotTranslation(final String responseCode, final String translation) {
        this.activity.runOnUiThread(new Runnable() { // from class: com.google.appinventor.components.runtime.Translator.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    @SimpleProperty(category = PropertyCategory.ADVANCED, description = "The API Key to use. MIT App Inventor will automatically fill this value in. You should not need to change it.", userVisible = SyntaxForms.DEBUGGING)
