...
public class ReplForm extends Form {
    ...
    public void onCreateFinish() {
        ...
        if (data != null && data.startsWith("aicompanion")) {
            registerForOnInitialize(new OnInitializeListener() { // from class: com.google.appinventor.components.runtime.ReplForm.1
    ...
    public void addSettingsButton(Menu menu) {
        MenuItem showSettingsItem = menu.add(0, 0, 3, "Settings").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: com.google.appinventor.components.runtime.ReplForm.3
    ...
    public void addLogcatButton(Menu menu) {
        if (ReplApplication.isAcraActive()) {
            MenuItem showSettingsItem = menu.add(0, 0, 4, "Send Error Report").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: com.google.appinventor.components.runtime.ReplForm.4
                @Override // android.view.MenuItem.OnMenuItemClickListener
                public boolean onMenuItemClick(MenuItem item) {
            ...
            showSettingsItem.setIcon(17301642);
        }
    }
    ...
    public void loadComponents(List<String> extensionNames) {
        ...
        java.io.File dexOutput = activeForm.$context().getDir("componentDexs", 0);
        java.io.File componentFolder = new java.io.File(this.replCompDir);
        ...
        for (java.io.File compFolder : componentFolder.listFiles()) {
            if (compFolder.isDirectory() && extensions.contains(compFolder.getName())) {
                java.io.File component = new java.io.File(compFolder.getPath() + java.io.File.separator + "classes.jar");
                java.io.File loadComponent = new java.io.File(compFolder.getPath() + java.io.File.separator + compFolder.getName() + ".jar");
    ...
    public String getCachePath(String cache) {
        return Build.VERSION.SDK_INT < 8 ? "file://" + Environment.getExternalStorageDirectory().getAbsolutePath() + "/AppInventor/cache/" + cache : "file://" + new java.io.File(getExternalCacheDir(), cache).getAbsolutePath();
    }
