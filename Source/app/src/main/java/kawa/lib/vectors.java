...
public class vectors extends ModuleBody {
    ...
    static {
        ...
        vector$Mn$Grlist = new ModuleMethod(vectorsVar, 7, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grvector = new ModuleMethod(vectorsVar, 8, Lit7, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
