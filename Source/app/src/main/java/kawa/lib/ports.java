...
public class ports extends ModuleBody {
    ...
    static {
        ...
        open$Mninput$Mnfile = new ModuleMethod(portsVar, 1, Lit10, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        open$Mnoutput$Mnfile = new ModuleMethod(portsVar, 2, Lit11, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        input$Mnport$Qu = new ModuleMethod(portsVar, 7, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        output$Mnport$Qu = new ModuleMethod(portsVar, 8, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        open$Mninput$Mnstring = new ModuleMethod(portsVar, 14, Lit19, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        open$Mnoutput$Mnstring = new ModuleMethod(portsVar, 15, Lit20, 0);
        get$Mnoutput$Mnstring = new ModuleMethod(portsVar, 16, Lit21, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        call$Mnwith$Mninput$Mnstring = new ModuleMethod(portsVar, 17, Lit22, 8194);
        call$Mnwith$Mnoutput$Mnstring = new ModuleMethod(portsVar, 18, Lit23, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        force$Mnoutput = new ModuleMethod(portsVar, 19, Lit24, 4096);
        newline = new ModuleMethod(portsVar, 21, Lit25, 4096);
        eof$Mnobject$Qu = new ModuleMethod(portsVar, 23, Lit26, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        input$Mnport$Mnread$Mnstate = new ModuleMethod(portsVar, 30, Lit30, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set$Mnport$Mnline$Ex = new ModuleMethod(portsVar, 31, Lit31, 8194);
        port$Mnline$Fn4 = new ModuleMethod(portsVar, 32, Lit32, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set$Mninput$Mnport$Mnline$Mnnumber$Ex = new ModuleMethod(portsVar, 33, Lit33, 8194);
        input$Mnport$Mnline$Mnnumber$Fn5 = new ModuleMethod(portsVar, 34, Lit34, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        port$Mncolumn = new ModuleMethod(portsVar, 35, Lit35, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        input$Mnport$Mncolumn$Mnnumber = new ModuleMethod(portsVar, 36, Lit36, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        default$Mnprompter = new ModuleMethod(portsVar, 37, Lit37, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set$Mninput$Mnport$Mnprompter$Ex = new ModuleMethod(portsVar, 38, Lit38, 8194);
        input$Mnport$Mnprompter$Fn6 = new ModuleMethod(portsVar, 39, Lit39, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        close$Mninput$Mnport = new ModuleMethod(portsVar, 40, Lit40, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        close$Mnoutput$Mnport = new ModuleMethod(portsVar, 41, Lit41, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        read = new ModuleMethod(portsVar, 42, Lit42, 4096);
        read$Mnline = new ModuleMethod(portsVar, 44, Lit43, 8192);
        transcript$Mnon = new ModuleMethod(portsVar, 47, Lit44, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
