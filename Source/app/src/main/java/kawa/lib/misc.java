...
public class misc extends ModuleBody {
    ...
    static {
        ...
        boolean$Qu = new ModuleMethod(miscVar, 3, Lit4, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbol$Qu = new ModuleMethod(miscVar, 4, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbol$Mn$Grstring = new ModuleMethod(miscVar, 5, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        symbol$Mnlocal$Mnname = new ModuleMethod(miscVar, 8, Lit7, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbol$Mnnamespace = new ModuleMethod(miscVar, 9, Lit8, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbol$Mnnamespace$Mnuri = new ModuleMethod(miscVar, 10, Lit9, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbol$Mnprefix = new ModuleMethod(miscVar, 11, Lit10, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        namespace$Mnuri = new ModuleMethod(miscVar, 12, Lit11, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        namespace$Mnprefix = new ModuleMethod(miscVar, 13, Lit12, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mn$Grsymbol = new ModuleMethod(miscVar, 14, Lit13, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        procedure$Qu = new ModuleMethod(miscVar, 15, Lit14, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        scheme$Mnreport$Mnenvironment = new ModuleMethod(miscVar, 20, Lit18, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        force = new ModuleMethod(miscVar, 27, Lit24, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
