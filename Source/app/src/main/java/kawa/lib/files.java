...
public class files extends ModuleBody {
    ...
    static {
        ...
        path$Qu = new ModuleMethod(filesVar, 1, Lit0, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        filepath$Qu = new ModuleMethod(filesVar, 2, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        URI$Qu = new ModuleMethod(filesVar, 3, Lit2, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        absolute$Mnpath$Qu = new ModuleMethod(filesVar, 4, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnscheme = new ModuleMethod(filesVar, 5, Lit4, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnauthority = new ModuleMethod(filesVar, 6, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnuser$Mninfo = new ModuleMethod(filesVar, 7, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnhost = new ModuleMethod(filesVar, 8, Lit7, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnfile = new ModuleMethod(filesVar, 9, Lit8, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mndirectory = new ModuleMethod(filesVar, 10, Lit9, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnparent = new ModuleMethod(filesVar, 11, Lit10, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnlast = new ModuleMethod(filesVar, 12, Lit11, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnextension = new ModuleMethod(filesVar, 13, Lit12, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnport = new ModuleMethod(filesVar, 14, Lit13, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnquery = new ModuleMethod(filesVar, 15, Lit14, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        path$Mnfragment = new ModuleMethod(filesVar, 16, Lit15, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        file$Mnexists$Qu = new ModuleMethod(filesVar, 17, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        file$Mndirectory$Qu = new ModuleMethod(filesVar, 18, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        file$Mnreadable$Qu = new ModuleMethod(filesVar, 19, Lit18, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        file$Mnwritable$Qu = new ModuleMethod(filesVar, 20, Lit19, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        delete$Mnfile = new ModuleMethod(filesVar, 21, Lit20, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        rename$Mnfile = new ModuleMethod(filesVar, 22, Lit21, 8194);
        copy$Mnfile = new ModuleMethod(filesVar, 23, Lit22, 8194);
        create$Mndirectory = new ModuleMethod(filesVar, 24, Lit23, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        directory$Mnfiles = new ModuleMethod(filesVar, 25, Lit24, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $Mn$Grpathname = new ModuleMethod(filesVar, 26, Lit25, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $Pcfile$Mnseparator = new ModuleMethod(filesVar, 27, Lit26, 0);
        system$Mntmpdir = new ModuleMethod(filesVar, 28, Lit27, 0);
        resolve$Mnuri = new ModuleMethod(filesVar, 29, Lit28, 8194);
        make$Mntemporary$Mnfile = new ModuleMethod(filesVar, 30, Lit29, 4096);
        $instance.run();
    }
