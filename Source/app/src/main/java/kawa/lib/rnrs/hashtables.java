...
public class hashtables extends ModuleBody {
    ...
    static {
        ...
        hash$Mnby$Mnidentity = new ModuleMethod(hashtablesVar, 1, Lit0, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        hash$Mnfor$Mneqv = new ModuleMethod(hashtablesVar, 2, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        hashtable$Qu = new ModuleMethod(hashtablesVar, 9, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        hashtable$Mnsize = new ModuleMethod(hashtablesVar, 10, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        hashtable$Mnkeys = new ModuleMethod(hashtablesVar, 20, Lit14, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        hashtable$Mnentries = new ModuleMethod(hashtablesVar, 21, Lit15, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        hashtable$Mnequivalence$Mnfunction = new ModuleMethod(hashtablesVar, 22, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        hashtable$Mnhash$Mnfunction = new ModuleMethod(hashtablesVar, 23, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        hashtable$Mnmutable$Qu = new ModuleMethod(hashtablesVar, 24, Lit18, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        equal$Mnhash = new ModuleMethod(hashtablesVar, 25, Lit19, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnhash = new ModuleMethod(hashtablesVar, 26, Lit20, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnci$Mnhash = new ModuleMethod(hashtablesVar, 27, Lit21, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbol$Mnhash = new ModuleMethod(hashtablesVar, 28, Lit22, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
