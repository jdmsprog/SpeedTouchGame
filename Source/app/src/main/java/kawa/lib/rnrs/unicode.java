...
public class unicode extends ModuleBody {
    ...
    static {
        ...
        char$Mngeneral$Mncategory = new ModuleMethod(unicodeVar, 16, Lit15, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnupcase = new ModuleMethod(unicodeVar, 17, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mndowncase = new ModuleMethod(unicodeVar, 18, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mntitlecase = new ModuleMethod(unicodeVar, 19, Lit18, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnfoldcase = new ModuleMethod(unicodeVar, 20, Lit19, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        string$Mnnormalize$Mnnfd = new ModuleMethod(unicodeVar, 26, Lit25, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnnormalize$Mnnfkd = new ModuleMethod(unicodeVar, 27, Lit26, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnnormalize$Mnnfc = new ModuleMethod(unicodeVar, 28, Lit27, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnnormalize$Mnnfkc = new ModuleMethod(unicodeVar, 29, Lit28, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
