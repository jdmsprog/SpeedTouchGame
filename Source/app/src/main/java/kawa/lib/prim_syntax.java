...
public class prim_syntax extends ModuleBody {
    ...
    public static final Macro f21if;
    ...
    static {
        ...
        syntax$Mnerror = new ModuleMethod(prim_syntaxVar, 1, Lit8, -4095);
        ...
        f21if = Macro.make(simpleSymbol7, moduleMethod, $instance);
    ...
    static Object lambda1(Object x) {
        ...
        if (Lit21.match(x, allocVars, 0)) {
            return syntaxError(Lit22.execute(allocVars, TemplateScope.make()), "too many expressions for 'if'" instanceof Object[] ? "too many expressions for 'if'" : new Object[]{"too many expressions for 'if'"});
        } else if (Lit23.match(x, allocVars, 0)) {
            return syntaxError(Lit24.execute(allocVars, TemplateScope.make()), "too few expressions for 'if'" instanceof Object[] ? "too few expressions for 'if'" : new Object[]{"too few expressions for 'if'"});
        } else {
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda4processBinding(Object b) {
            ...
            if (prim_syntax.Lit35.match(b, allocVars, 0)) {
                ...
                return prim_syntax.syntaxError(b, "missing initializion in letrec" instanceof Object[] ? "missing initializion in letrec" : new Object[]{"missing initializion in letrec"});
            } else if (prim_syntax.Lit44.match(b, allocVars, 0)) {
                return prim_syntax.syntaxError(b, "invalid bindings syntax in letrec" instanceof Object[] ? "invalid bindings syntax in letrec" : new Object[]{"invalid bindings syntax in letrec"});
            } else {
