...
public class lists extends ModuleBody {
    ...
    static {
        ...
        pair$Qu = new ModuleMethod(listsVar, 1, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        cons = new ModuleMethod(listsVar, 2, Lit4, 8194);
        null$Qu = new ModuleMethod(listsVar, 3, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        length = new ModuleMethod(listsVar, 64, Lit8, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        reverse = new ModuleMethod(listsVar, 65, Lit9, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mntail = new ModuleMethod(listsVar, 66, Lit10, 8194);
        list$Mnref = new ModuleMethod(listsVar, 67, Lit11, 8194);
        list$Qu = new ModuleMethod(listsVar, 68, Lit12, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        reverse$Ex = new ModuleMethod(listsVar, 69, Lit13, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
