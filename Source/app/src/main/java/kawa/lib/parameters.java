...
public class parameters extends ModuleBody {
    ...
    static {
        ...
        make$Mnparameter = new ModuleMethod(parametersVar, 1, Lit0, 8193);
        $Prvt$as$Mnlocation$Pc = new ModuleMethod(parametersVar, 3, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
