...
public class system extends ModuleBody {
    ...
    public static final ModuleMethod f26catch;
    ...
    static {
        ...
        f26catch = new ModuleMethod(systemVar, 9, Lit10, 12291);
    ...
    public static Object tokenizeStringToStringArray(String string) {
        ...
        try {
            ...
            throw new WrongType(e2, PropertyTypeConstants.PROPERTY_TYPE_LENGTH, 1, lList);
        }
    }
    ...
    /* renamed from: catch  reason: not valid java name */
    public static Object m565catch(Object key, Procedure thunk, Procedure handler) {
        try {
            return thunk.apply0();
    ...
    public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
        if (moduleMethod.selector == 9) {
            try {
                try {
                    return m565catch(obj, (Procedure) obj2, (Procedure) obj3);
                } catch (ClassCastException e) {
