...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    static {
        $assertionsDisabled = !WindowDecorActionBar.class.desiredAssertionStatus() ? true : $assertionsDisabled;
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
            return this.mCallback != null ? this.mCallback.onActionItemClicked(this, item) : WindowDecorActionBar.$assertionsDisabled;
        }
