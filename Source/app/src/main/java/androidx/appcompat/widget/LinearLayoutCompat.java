                ...
                if (child3.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp3.height != 0 || heightMode != 1073741824) {
                            ...
                            child3.measure(childWidthMeasureSpec, View.MeasureSpec.makeMeasureSpec(share, Declaration.MODULE_REFERENCE));
                        }
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
                ...
                if (child3 != null && child3.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp3.width != 0 || widthMode != 1073741824) {
                            ...
                            child3.measure(View.MeasureSpec.makeMeasureSpec(childWidth2, Declaration.MODULE_REFERENCE), childHeightMeasureSpec);
                        } else {
                            if (share <= 0) {
                                share = 0;
                            }
                            child3.measure(View.MeasureSpec.makeMeasureSpec(share, Declaration.MODULE_REFERENCE), childHeightMeasureSpec);
                        }
            ...
            if (useLargestChild && widthMode != 1073741824) {
                for (int i4 = 0; i4 < count; i4++) {
                    View child4 = getVirtualChildAt(i4);
                    if (child4 != null && child4.getVisibility() != 8 && ((LayoutParams) child4.getLayoutParams()).weight > 0.0f) {
                        child4.measure(View.MeasureSpec.makeMeasureSpec(largestChildWidth, Declaration.MODULE_REFERENCE), View.MeasureSpec.makeMeasureSpec(child4.getMeasuredHeight(), Declaration.MODULE_REFERENCE));
                    }
                }
            }
        }
