...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
        ...
        if (needsExpansion) {
            for (int i5 = 0; i5 < childCount; i5++) {
                ...
                if (lp5.expanded) {
                    ...
                    child4.measure(View.MeasureSpec.makeMeasureSpec(width, Declaration.MODULE_REFERENCE), itemHeightSpec);
                }
            }
        }
    ...
    public static int measureChildForCells(View child, int cellSize, int cellsRemaining, int parentHeightMeasureSpec, int parentHeightPadding) {
        ...
        child.measure(View.MeasureSpec.makeMeasureSpec(targetWidth, Declaration.MODULE_REFERENCE), childHeightSpec);
        return cellsUsed;
    }
