...
public class AccessibilityNodeInfoCompat {
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading) {
            return Build.VERSION.SDK_INT >= 19 ? new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(rowIndex, rowSpan, columnIndex, columnSpan, heading)) : new CollectionItemInfoCompat(null);
        }
    ...
    private void setBooleanProperty(int property, boolean value) {
        ...
        if (extras != null) {
            ...
            extras.putInt(BOOLEAN_PROPERTY_KEY, booleanProperties2 | property);
        }
    }
