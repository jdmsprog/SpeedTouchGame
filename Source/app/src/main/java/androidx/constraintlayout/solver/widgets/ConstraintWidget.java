...
public class ConstraintWidget {
    ...
    public void addToSolver(LinearSystem system) {
        ...
        if (this.mParent != null) {
            if (this.mParent != null) {
                horizontalParentWrapContent = this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT ? true : AUTOTAG_CENTER;
            } else {
                horizontalParentWrapContent = AUTOTAG_CENTER;
            }
            if (this.mParent != null) {
                verticalParentWrapContent = this.mParent.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT ? true : AUTOTAG_CENTER;
            } else {
                verticalParentWrapContent = AUTOTAG_CENTER;
            }
            if (isChainHead(0)) {
        ...
        boolean useHorizontalRatio = (useRatio && (this.mResolvedDimensionRatioSide == 0 || this.mResolvedDimensionRatioSide == -1)) ? true : AUTOTAG_CENTER;
        boolean wrapContent = (this.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer)) ? true : AUTOTAG_CENTER;
        ...
        if (this.mHorizontalResolution != 2) {
            ...
            applyConstraints(system, horizontalParentWrapContent, parentMin, parentMax, this.mListDimensionBehaviors[0], wrapContent, this.mLeft, this.mRight, this.mX, width, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, useHorizontalRatio, inHorizontalChain, matchConstraintDefaultWidth, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, applyPosition);
        }
        if (this.mVerticalResolution != 2) {
            boolean wrapContent2 = (this.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT && (this instanceof ConstraintWidgetContainer)) ? true : AUTOTAG_CENTER;
            boolean useVerticalRatio = (useRatio && (this.mResolvedDimensionRatioSide == 1 || this.mResolvedDimensionRatioSide == -1)) ? true : AUTOTAG_CENTER;
            if (this.mBaselineDistance > 0) {
                if (this.mBaseline.getResolutionNode().state == 1) {
                    ...
                    if (this.mBaseline.mTarget != null) {
                        ...
                        system.addEquality(baseline, baselineTarget, 0, 6);
                        applyPosition = AUTOTAG_CENTER;
                    }
                }
            }
            SolverVariable parentMax2 = this.mParent != null ? system.createObjectVariable(this.mParent.mBottom) : null;
            SolverVariable parentMin2 = this.mParent != null ? system.createObjectVariable(this.mParent.mTop) : null;
            applyConstraints(system, verticalParentWrapContent, parentMin2, parentMax2, this.mListDimensionBehaviors[1], wrapContent2, this.mTop, this.mBottom, this.mY, height, this.mMinHeight, this.mMaxDimension[1], this.mVerticalBiasPercent, useVerticalRatio, inVerticalChain, matchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, applyPosition);
            if (useRatio) {
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        int numConnections = isBeginConnected ? 0 + 1 : 0;
        if (isEndConnected) {
            numConnections++;
        }
