...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget widget, int orientation, boolean topLeftFlow, int depth) {
        ...
        while (it.hasNext()) {
            ...
            dimensionPre = Math.max(dimensionPre, getMaxDimensionTraversal(((ResolutionAnchor) targetNode).myAnchor.mOwner, orientation, topLeftFlow, downDepth));
        }
        ...
        while (it2.hasNext()) {
            ...
            dimensionPost2 = Math.max(dimensionPost2, getMaxDimensionTraversal(((ResolutionAnchor) targetNode2).myAnchor.mOwner, orientation, topLeftFlow, postTemp + downDepth));
        }
        if (hasBaseline) {
