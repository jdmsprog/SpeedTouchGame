...
public class NodeTree extends TreeList {
    ...
    public boolean posHasAttributes(int ipos) {
        ...
        return index >= 0 && index >= 0 && this.data[index] == 61705;
    }

    public int getAttribute(int parent, String namespaceURI, String localName) {
        return getAttributeI(parent, namespaceURI == null ? null : namespaceURI.intern(), localName != null ? localName.intern() : null);
    }
