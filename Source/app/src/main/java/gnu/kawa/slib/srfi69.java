...
public class srfi69 extends ModuleBody {
    ...
    static {
        ...
        hash$Mntable$Mnequivalence$Mnfunction = new ModuleMethod(srfi69Var, 9, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        hash$Mntable$Mnhash$Mnfunction = new ModuleMethod(srfi69Var, 10, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        hash$Mntable$Mn$Gralist = new ModuleMethod(srfi69Var, 28, Lit15, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        hash$Mntable$Mncopy = new ModuleMethod(srfi69Var, 29, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        hash$Mntable$Mnkeys = new ModuleMethod(srfi69Var, 32, Lit18, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        hash$Mntable$Mnvalues = new ModuleMethod(srfi69Var, 34, Lit19, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
    ...
    static Procedure appropriateHashFunctionFor(Object comparison) {
        ...
        Object x3 = comparison == strings.string$Eq$Qu ? 1 : null;
        Object x4 = x3 != null ? string$Mnhash : x3 != null ? Boolean.TRUE : Boolean.FALSE;
        if (x4 != Boolean.FALSE) {
            return (Procedure) x4;
        }
        Object x5 = comparison == unicode.string$Mnci$Eq$Qu ? 1 : null;
        Object x6 = x5 != null ? string$Mnci$Mnhash : x5 != null ? Boolean.TRUE : Boolean.FALSE;
